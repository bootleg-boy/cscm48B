                    ...
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><?php echo $post->title; ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('user_post.edit', $post->id)); ?>" class="btn btn-sm btn-outline-success py-0" style="font-size: 0.8em;">Edit Post</a>
                                <form action="<?php echo e(route('user_post.destroy', $post->id)); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bjl/Documents/Metetials/blog1/laravel-microblog/resources/views/user/post/index.blade.php ENDPATH**/ ?>